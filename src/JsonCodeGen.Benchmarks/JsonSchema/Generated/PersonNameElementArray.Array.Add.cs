...
public readonly partial struct PersonNameElementArray
{
    ...
    public PersonNameElementArray Add(in GenFromJsonSchema.PersonNameElement item1)
    {
        ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        builder.Add(item1);
        return new(builder.ToImmutable());
    ...
    /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
    public PersonNameElementArray Add(params GenFromJsonSchema.PersonNameElement[] items)
    {
        ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        foreach (GenFromJsonSchema.PersonNameElement item in items)
        {
            builder.Add(item.AsAny);
        }
    ...
    /// <returns>An instance of the array with the items added.</returns>
    /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
    public PersonNameElementArray AddRange(IEnumerable<GenFromJsonSchema.PersonNameElement> items)
    {
        ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        foreach (GenFromJsonSchema.PersonNameElement item in items)
        {
    ...
    /// <returns>An instance of the array with the item added.</returns>
    /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
    public PersonNameElementArray Insert(int index, in GenFromJsonSchema.PersonNameElement item1)
    {
        return new(this.GetImmutableListWith(index, item1));
    }
    ...
    public PersonNameElementArray InsertRange(int index, IEnumerable<GenFromJsonSchema.PersonNameElement> items)
    {
        return new(this.GetImmutableListWith(index, items.Select(item => item.AsAny)));
    }
    ...
    /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
    public PersonNameElementArray Replace(in GenFromJsonSchema.PersonNameElement oldValue, in GenFromJsonSchema.PersonNameElement newValue)
    {
        return new(this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny));
    }
    ...
    public PersonNameElementArray SetItem(int index, in GenFromJsonSchema.PersonNameElement value)
    {
        return new(this.GetImmutableListSetting(index, value.AsAny));
    }
}