...
public readonly partial struct PersonNameElementArray : IJsonArray<PersonNameElementArray>, IEnumerable<GenFromJsonSchema.PersonNameElement>
#else
...
#endif
{
    ...
    public GenFromJsonSchema.PersonNameElement this[int index]
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new GenFromJsonSchema.PersonNameElement(this.jsonElementBacking[index]);
            }
            ...
            if ((this.backing & Backing.Array) != 0)
            {
                try
                {
                    return this.arrayBacking[index].As<GenFromJsonSchema.PersonNameElement>();
                }
                catch (ArgumentOutOfRangeException ex)
                {
                    throw new IndexOutOfRangeException(ex.Message, ex);
    ...
    public static PersonNameElementArray Create(ReadOnlySpan<GenFromJsonSchema.PersonNameElement> items)
    {
        return new([..items]);
    }
    ...
    public static PersonNameElementArray FromItems(in GenFromJsonSchema.PersonNameElement value1)
    {
    ...
    /// <returns>A PersonNameElementArray instantiated from the given items.</returns>
    public static PersonNameElementArray FromItems(in GenFromJsonSchema.PersonNameElement value1, in GenFromJsonSchema.PersonNameElement value2)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
    ...
    /// <returns>A PersonNameElementArray instantiated from the given items.</returns>
    public static PersonNameElementArray FromItems(in GenFromJsonSchema.PersonNameElement value1, in GenFromJsonSchema.PersonNameElement value2, in GenFromJsonSchema.PersonNameElement value3)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
        builder.Add(value2.AsAny);
    ...
    public static PersonNameElementArray FromItems(params GenFromJsonSchema.PersonNameElement[] value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        foreach (GenFromJsonSchema.PersonNameElement item in value)
        {
    ...
    /// <param name = "value">The value from which to construct the instance.</param>
    /// <returns>A JsonAny instantiated from the given items.</returns>
    public static PersonNameElementArray FromRange(IEnumerable<GenFromJsonSchema.PersonNameElement> value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        foreach (GenFromJsonSchema.PersonNameElement item in value)
        {
...
#if NET8_0_OR_GREATER
    /// <inheritdoc />
    IEnumerator<GenFromJsonSchema.PersonNameElement> IEnumerable<GenFromJsonSchema.PersonNameElement>.GetEnumerator()
    {
    ...
    /// <inheritdoc/>
    public JsonArrayEnumerator<GenFromJsonSchema.PersonNameElement> EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new JsonArrayEnumerator<GenFromJsonSchema.PersonNameElement>(this.jsonElementBacking);
        }

        if ((this.backing & Backing.Array) != 0)
        {
            return new JsonArrayEnumerator<GenFromJsonSchema.PersonNameElement>(this.arrayBacking);
        }
