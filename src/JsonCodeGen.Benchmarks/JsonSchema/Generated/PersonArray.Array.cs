...
public readonly partial struct PersonArray : IJsonArray<PersonArray>, IEnumerable<GenFromJsonSchema.Person>
#else
...
#endif
{
    ...
    /// Gets an empty array.
    /// </summary>
    public static readonly PersonArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
    /// <summary>
    ...
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public PersonArray(IEnumerable<JsonAny> value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.Array;
    ...
    public GenFromJsonSchema.Person this[int index]
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new GenFromJsonSchema.Person(this.jsonElementBacking[index]);
            }
            ...
            if ((this.backing & Backing.Array) != 0)
            {
                try
                {
                    return this.arrayBacking[index].As<GenFromJsonSchema.Person>();
                }
                catch (ArgumentOutOfRangeException ex)
                {
                    throw new IndexOutOfRangeException(ex.Message, ex);
    ...
    public static PersonArray Create(ReadOnlySpan<GenFromJsonSchema.Person> items)
    {
        return new([..items]);
    }
    ...
    /// <returns>A PersonArray instantiated from the given items.</returns>
    public static PersonArray FromItems(in GenFromJsonSchema.Person value1)
    {
    ...
    /// <returns>A PersonArray instantiated from the given items.</returns>
    public static PersonArray FromItems(in GenFromJsonSchema.Person value1, in GenFromJsonSchema.Person value2)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
    ...
    /// <returns>A PersonArray instantiated from the given items.</returns>
    public static PersonArray FromItems(in GenFromJsonSchema.Person value1, in GenFromJsonSchema.Person value2, in GenFromJsonSchema.Person value3)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
        builder.Add(value2.AsAny);
    ...
    public static PersonArray FromItems(params GenFromJsonSchema.Person[] value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        foreach (GenFromJsonSchema.Person item in value)
        {
    ...
    /// <param name = "value">The value from which to construct the instance.</param>
    /// <returns>A JsonAny instantiated from the given items.</returns>
    public static PersonArray FromRange(IEnumerable<GenFromJsonSchema.Person> value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        foreach (GenFromJsonSchema.Person item in value)
        {
    ...
    /// </remarks>
    public static PersonArray From<T>(IEnumerable<T> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        return new PersonArray(builder.ToImmutable());
    }
...
#if NET8_0_OR_GREATER
    /// <inheritdoc />
    IEnumerator<GenFromJsonSchema.Person> IEnumerable<GenFromJsonSchema.Person>.GetEnumerator()
    {
    ...
    /// <inheritdoc/>
    public JsonArrayEnumerator<GenFromJsonSchema.Person> EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new JsonArrayEnumerator<GenFromJsonSchema.Person>(this.jsonElementBacking);
        }

        if ((this.backing & Backing.Array) != 0)
        {
            return new JsonArrayEnumerator<GenFromJsonSchema.Person>(this.arrayBacking);
        }
