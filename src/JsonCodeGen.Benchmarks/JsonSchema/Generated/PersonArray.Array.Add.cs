...
public readonly partial struct PersonArray
{
    ...
    public PersonArray Add(in GenFromJsonSchema.Person item1)
    {
        ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        builder.Add(item1);
        return new(builder.ToImmutable());
    ...
    /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
    public PersonArray Add(params GenFromJsonSchema.Person[] items)
    {
        ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        foreach (GenFromJsonSchema.Person item in items)
        {
            builder.Add(item.AsAny);
        }
    ...
    /// <returns>An instance of the array with the items added.</returns>
    /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
    public PersonArray AddRange(IEnumerable<GenFromJsonSchema.Person> items)
    {
        ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        foreach (GenFromJsonSchema.Person item in items)
        {
    ...
    /// <returns>An instance of the array with the item added.</returns>
    /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
    public PersonArray Insert(int index, in GenFromJsonSchema.Person item1)
    {
        return new(this.GetImmutableListWith(index, item1));
    }
    ...
    public PersonArray InsertRange(int index, IEnumerable<GenFromJsonSchema.Person> items)
    {
        return new(this.GetImmutableListWith(index, items.Select(item => item.AsAny)));
    }
    ...
    /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
    public PersonArray Replace(in GenFromJsonSchema.Person oldValue, in GenFromJsonSchema.Person newValue)
    {
        return new(this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny));
    }
    ...
    public PersonArray SetItem(int index, in GenFromJsonSchema.Person value)
    {
        return new(this.GetImmutableListSetting(index, value.AsAny));
    }
}